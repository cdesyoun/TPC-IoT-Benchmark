...
echo "Enter client file" | tee -a /oasis/scratch/comet/klin/temp_project/tmp.log
...
echo "$PWD $prefix $clientId $LOGFILE_NAME $i" | tee -a /oasis/scratch/comet/klin/temp_project/tmp.log
